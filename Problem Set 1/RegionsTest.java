	...
	public static void main(String[] args) { 
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				// testing the different colors on images

				// shape image
				new RegionsTest("shapes red", new RegionFinder(loadImage("pictures/shapes.jpg")), new Color(255, 0, 0));
				new RegionsTest("shapes yellow", new RegionFinder(loadImage("pictures/shapes.jpg")), new Color (255, 255, 0));
				new RegionsTest("shapes blue", new RegionFinder(loadImage("pictures/shapes.jpg")), new Color (0, 0, 255));
